...
if __name__ == "__main__":
    ...
    print(my_account.display_balance())  # Output: "Account Balance for John Doe (Account #12345): $1500.00"

    # Withdraw and display balance
    my_account.withdraw(200.0)
    print(my_account.display_balance())  # Output: "Account Balance for John Doe (Account #12345): $1300.00"